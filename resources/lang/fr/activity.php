...
return [
    ...
    'user' => [
        ...
        'account' => [
            ...
            'avatar-changed' => 'Photo de profil changée',
        ...
        'screen' => [
            'share' => 'A partagé son écran avec le support',
            'decline' => 'A refusé de partager son écran',
            'stop' => 'A arrêté de partager son écran',
        ],
        'two-factor' => [
    ...
    'admin' => [
        'screen' => [
            'request' => "A demandé à voir l'écran de :username",
        ],
    ],
    'server' => [
