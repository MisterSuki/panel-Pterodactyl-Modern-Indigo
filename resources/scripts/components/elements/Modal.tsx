...
export const ModalMask = styled.div`
    ${tw`fixed z-50 overflow-auto flex w-full inset-0 backdrop-blur-sm`};
        ...
        <Fade in={render} timeout={150} appear={appear || true} unmountOnExit onExited={() => onDismissed()}>
            ...
            >
                <ModalContainer alignTop={top}>
                    ...
                    <div
                        css={tw`bg-neutral-800 border border-white/10 p-3 sm:p-4 md:p-6 rounded-2xl shadow-card overflow-y-scroll transition-all duration-150`}
                    >
                        {children}
                    </div>
                </ModalContainer>
