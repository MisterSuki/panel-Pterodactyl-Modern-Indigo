...
const ToggleContainer = styled.div`
    ...
    & > input[type='checkbox'] {
        ...
        &:checked + label {
            ${tw`bg-gradient-brand-flat border-primary-500 shadow-none`};
        }
    ...
    & > label {
        ${tw`mb-0 block overflow-hidden cursor-pointer bg-neutral-600 border border-white/10 rounded-full h-6 shadow-inner transition-colors duration-150`};
